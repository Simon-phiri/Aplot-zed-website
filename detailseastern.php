...
<body>
    ...
    <img src="Photos/chipata.jfif" alt="Picture of Livingstone tourists">
    <h1 class="image-heading">Welcome to Eastern Province, Home to the Nyau Dancers</h1>
</div>
    ...
    <div class="table-container">
        <table>
            ...
            <tr class="flight-row">
                <td><img src="Photos/Travel-img.jfif" style="height: 90px; width: 95px; margin-left: -4 px; border-radius: 100%;" alt="Airline 1 Icon"></td>
                <td>Travel Agency</td>
                <td>08:00 AM</td>
                <td>2 hours</td>
                <td>
                ...
                <td colspan="5">
                    ...
                    <div class="details-content">
                        ...
                        <ul>
                            ...
                            <a href="selected_flight_TA.php" class="select-flight-button">Select Flight</a>
                     </div>
                </td>
            </tr>
            
            <tr class="flight-row">
                <td><img src="Photos/zed airways.jfif" style="height: 90px; width: 95px; margin-left: -4 px; border-radius: 100%;" alt="Airline 1 Icon"></td>
            ...
            <tr class="flight-row">
                <td><img src="Photos/air-moroco.png" style="height: auto; width: 85px;" alt="Airline 3 Icon"></td>
                <td>Air Morocca</td>
                ...
                <td colspan="5">
                    ...
                    <div class="details-content">
                        ...
                        <ul>
                            ...
                            <a href="selected_flight_AM.php" class="select-flight-button">Select Flight</a>
                     </div>
                </td>
            </tr>
        </table>
