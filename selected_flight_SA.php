...
<body>
<div class="header">
    <img src="Photos/SA Airways.jfif" style="height: auto; width: 125px; margin-left: -4 px;" alt="Airline 1 Icon"><h1>SA Airways </h1>
</div>
<div class="container">
    <div class="notice">
...
$(document).ready(function () {
    ...
    $('#confirmPin').on('click', function () {
        ...
        alert('Thank you for confriming your Pin.');
